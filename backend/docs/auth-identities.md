...
## Что это
`identities` — таблица, которая связывает пользователя с внешними провайдерами (local, github, yandex, telegram). Это позволяет добавить OAuth без рефакторинга моделей и сессий.
