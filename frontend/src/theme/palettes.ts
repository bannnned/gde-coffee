...
export const APP_PALETTES = {
  coffee: {
    ...
    light: {
      brandAccent: "#457E73",
      brandAccentSoft: "rgba(69, 126, 115, 0.28)",
      brandAccentStrong: "#2f5f55",
      onAccent: "#FFFFF0",

      bgBase: "#EADCC8",
      bgAccent1: "rgba(69, 126, 115, 0.18)",
      bgAccent2: "rgba(255, 255, 240, 0.35)",

      cardBg: "#FFFFF0",
      surfaceBg: "rgba(255, 255, 240, 0.72)",
      overlaySoft: "rgba(26, 26, 26, 0.12)",
      overlayStrong: "rgba(26, 26, 26, 0.35)",

      textPrimary: "#1A1A1A",
      textMuted: "rgba(26, 26, 26, 0.65)",
      textInverse: "#FFFFF0",

      borderSoft: "rgba(26, 26, 26, 0.12)",
      borderStrong: "rgba(255, 255, 240, 0.8)",
      glassBorder: "rgba(255, 255, 240, 0.75)",

      glassBg: "rgba(255, 255, 240, 0.65)",
      glassShadow: "0 12px 30px rgba(26, 26, 26, 0.14)",
      glassGrad1: "rgba(255, 255, 240, 0.95)",
      glassGrad2: "rgba(255, 255, 240, 0.65)",
      glassGradHover1: "rgba(255, 255, 240, 0.98)",
      glassGradHover2: "rgba(255, 255, 240, 0.75)",

      shadowLg: "0 18px 40px rgba(26, 26, 26, 0.16)",
      attentionRing: "rgba(69, 126, 115, 0.42)",
      attentionGlow: "rgba(69, 126, 115, 0.28)",
      ...
      mapUserMarker: "#FFFFF0",
      mapCafeMarker: "#457E73",
      mapLabelText: "#1A1A1A",
      mapLabelHalo: "rgba(255, 255, 240, 0.9)",
    },
    dark: {
      brandAccent: "#5aa294",
      brandAccentSoft: "rgba(90, 162, 148, 0.28)",
      brandAccentStrong: "#6ec0b1",
      onAccent: "#0f1917",

      bgBase: "#1A1A1A",
      bgAccent1: "rgba(69, 126, 115, 0.22)",
      bgAccent2: "rgba(234, 220, 200, 0.14)",

      cardBg: "rgba(255, 255, 240, 0.07)",
      surfaceBg: "rgba(255, 255, 240, 0.05)",
      overlaySoft: "rgba(26, 26, 26, 0.45)",
      overlayStrong: "rgba(26, 26, 26, 0.65)",

      textPrimary: "#FFFFF0",
      textMuted: "rgba(255, 255, 240, 0.7)",
      textInverse: "#1A1A1A",

      borderSoft: "rgba(255, 255, 240, 0.16)",
      borderStrong: "rgba(255, 255, 240, 0.18)",
      glassBorder: "rgba(255, 255, 240, 0.14)",

      glassBg: "rgba(26, 26, 26, 0.7)",
      glassShadow: "0 12px 30px rgba(0, 0, 0, 0.6)",
      glassGrad1: "rgba(26, 26, 26, 0.85)",
      glassGrad2: "rgba(26, 26, 26, 0.5)",
      glassGradHover1: "rgba(26, 26, 26, 0.95)",
      glassGradHover2: "rgba(26, 26, 26, 0.6)",

      shadowLg: "0 18px 40px rgba(0, 0, 0, 0.6)",
      attentionRing: "rgba(90, 162, 148, 0.5)",
      attentionGlow: "rgba(90, 162, 148, 0.32)",

      statusSuccess: "#40c057",
      statusWarning: "#fab005",
      statusError: "#ff6b6b",
      statusInfo: "#4dabf7",

      mapUserMarker: "#FFFFF0",
      mapCafeMarker: "#5aa294",
      mapLabelText: "#FFFFF0",
      mapLabelHalo: "rgba(26, 26, 26, 0.92)",
    },
  },
  matcha: {
    label: "Matcha Studio",
